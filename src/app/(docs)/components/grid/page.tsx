...
export default function GridPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold mb-4">Grid Component</h1>
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`import { Grid } from '@primitivekit/react';`}</code>
        </pre>
      </section>
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`<Grid
  style={{
    '--grid-bg-color': 'rgba(59, 130, 246, 1)',
    '--grid-text-color': 'rgba(255, 255, 255, 1)',
...
/>`}</code>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          The Grid component follows WCAG 2.1 AA standards:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-600">
