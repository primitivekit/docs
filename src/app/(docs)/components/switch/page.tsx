...
export default function SwitchPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold mb-4">Switch Component</h1>
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`import { Switch } from '@primitivekit/react';`}</code>
        </pre>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          Customize the switch using CSS variables:
        </p>
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`<Switch
  style={{
    '--switch-bg-color': 'rgba(59, 130, 246, 1)',
...
/>`}</code>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          The Switch component follows WCAG 2.1 AA standards:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-600">
