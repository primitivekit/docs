    ...
    <div className="space-y-12">
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`import { Pagination } from '@primitivekit/react';`}</code>
        </pre>
      </section>
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`<Pagination total={100} />`}</code>
        </pre>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          Customize the pagination using CSS variables:
        </p>
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`<Pagination
  style={{
    '--pagination-bg-color': 'rgba(59, 130, 246, 1)',
    '--pagination-text-color': 'rgba(255, 255, 255, 1)',
...
/>`}</code>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          The Pagination component follows WCAG 2.1 AA standards:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-600">
