...
export default function TextareaPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold mb-4">Textarea Component</h1>
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`import { Textarea } from '@primitivekit/react';`}</code>
        </pre>
      </section>
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`<Textarea
  style={{
    '--textarea-bg-color': 'rgba(59, 130, 246, 1)',
    '--textarea-text-color': 'rgba(255, 255, 255, 1)',
