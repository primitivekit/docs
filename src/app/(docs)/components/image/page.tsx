...
export default function ImagePage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold mb-4">Image Component</h1>
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`import { Image } from '@primitivekit/react';`}</code>
        </pre>
      </section>
...
/>`}</code>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          Customize the image using CSS variables:
        </p>
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`<Image
  style={{
    '--image-bg-color': 'rgba(59, 130, 246, 1)',
    '--image-text-color': 'rgba(255, 255, 255, 1)',
