...
export default function MenuPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold mb-4">Menu Component</h1>
      ...
      <section>
        ...
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`import { Menu } from '@primitivekit/react';`}</code>
        </pre>
      </section>
...
/>`}</code>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          Customize the menu using CSS variables:
        </p>
        <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
          <code>{`<Menu
  style={{
    '--menu-bg-color': 'rgba(59, 130, 246, 1)',
...
/>`}</code>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          The Menu component follows WCAG 2.1 AA standards:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-600">
