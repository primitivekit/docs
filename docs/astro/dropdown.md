...
```astro
import { Dropdown } from '@primitivekit/astro';
```
...
- [Popover](/docs/astro/popover) - Overlay component for displaying rich content in a floating panel triggered by user interaction.
