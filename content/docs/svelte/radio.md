---
title: "Radio"
description: "Form input component for selecting a single option from a set of mutually exclusive choices."
framework: "svelte"
category: "form"
weight: 282
tags: ["form", "svelte"]
version: "0.1.0"
wcagLevel: "AA"
relatedComponents: ["Button","Input","Select","Checkbox","Switch"]
---
...
```svelte
import Radio from '@primitivekit/svelte/Radio.svelte';
```
