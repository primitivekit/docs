---
title: "Table"
description: "Data display component for showing structured data in rows and columns with sorting and pagination."
framework: "svelte"
...
version: "0.1.0"
wcagLevel: "AA"
relatedComponents: ["Avatar","Tag","Collapse","Image","Empty"]
---
...
```svelte
import Table from '@primitivekit/svelte/Table.svelte';
```
