---
title: "Tabs"
description: "Navigation component for organizing content into multiple panels with tab selection."
framework: "angular"
category: "navigation"
weight: 484
...
version: "0.1.0"
wcagLevel: "AA"
relatedComponents: ["Link","Breadcrumb","Menu","Steps","Pagination"]
---
...
```typescript
import { TabsComponent } from '@primitivekit/angular';
```

## Basic Usage

```typescript
<pk-tabs>Content</pk-tabs>
```
