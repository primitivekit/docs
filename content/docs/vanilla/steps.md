---
title: "Steps"
description: "Navigation component for showing progress through a multi-step process or wizard."
framework: "vanilla"
category: "navigation"
weight: 483
...
version: "0.1.0"
wcagLevel: "AA"
relatedComponents: ["Link","Breadcrumb","Tabs","Menu","Pagination"]
---
...
```javascript
import { Steps } from '@primitivekit/vanilla';
```

## Basic Usage

```javascript
const steps = new Steps({ /* options */ });
document.body.appendChild(steps.element);
```
